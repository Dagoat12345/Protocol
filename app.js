...
.setbox-row input{width:96px;background:var(--surface);border:1px solid var(--accent);color:var(--text);border-radius:14px;padding:16px;font-size:30px;font-weight:800;text-align:center;}
